...
struct iOSLanguageSelectionView: View {
    ...
    private func getLanguageDescription(for language: Language) -> LocalizedStringKey {
        switch language {
        case .english:
            return "str.lang_english"
        case .france:
            return "str.lang_french"
        case .germany:
            return "str.lang_german"
        case .uzbek:
            return "str.lang_uzbek"
        }
    }
}
#endif
